        ...
        if (AOE目标 != null)
        {
            if (!Core.Me.IsMoving())
            {
                ...
                if (火状态)
                {
                    if (耀星.CanSpell())
                    {
                        slot.Add(耀星.getAoeSpell());
                        if (MP == 0)
                        {
                            slot.Add(星灵移位.getSmartSpell());
                        }
                ...
                if (冰状态)
                {
                    if (玄冰.CanSpell())
                    {
                        slot.Add(玄冰.getSmartSpell());
                        if (通晓层数 > 0)
                        {
                            slot.Add(秽浊.getSmartSpell());
                            slot.Add(星灵移位.GetChangeSpell());
                        }
                    }
                }
            }
